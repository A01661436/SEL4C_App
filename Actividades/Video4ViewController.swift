...
class Video4ViewController: UIViewController, UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBAction func SubirVideo(_ sender: Any) {
        let requestBody = self.multipartFormDataBodyV(self.boundary,"Identificacion","Completado",UserDefaults.standard.integer(forKey: "usuarioID"), self.VideoToPass!)

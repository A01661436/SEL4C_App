//
//  PitchVViewController.swift
//  Actividades
//
//  Created by Usuario on 18/10/23.
//
...
class PitchVViewController: UIViewController ,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
